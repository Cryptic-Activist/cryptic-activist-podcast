...
import UploadCover from '../../../../components/Uploader/Admin/UploadFieldAdmin';
import FileListCover from '../../../../components/Uploader/Admin/FileListCoverAdmin';
...
const RegisterAdmin = (props) => {
  ...
  const verifyAdminUser = async () => {
    const response = await fetch(`https://cryptic-activist-podcast-api.herokuapp.com/admin/user/verify/admin/username/${adminUser}`,
      {
        method: 'GET',
        mode: 'cors',
        cache: 'no-cache',
