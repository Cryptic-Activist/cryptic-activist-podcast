...
function Edit(props) {
  ...
  useEffect(() => {
    ...
    setGoogleEpisodeUrl(googleEpisodeUrl);
    setSpotifyEpisodeUrl(spotifyEpisodeUrl);
    setItunesEpisodeUrl(itunesEpisodeUrl);
  ...
  const handleEditorChange = async (e) => {
    ...
    console.log('e.target.getContent():', e.target)
  };
