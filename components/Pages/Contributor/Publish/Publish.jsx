...
import UploadCover from '../../../Uploader/UploadCover';
...
} from '../../../../styles/Pages/Contributor/Publish/publish.styled-components';
...
const Publish = (props) => {
  ...
  const changeSlugFromTitle = () => {
    ...
    const slugLower = stringConverter.toSlug(lowerCaseTitle);
    setSlug(slugLower);
  };
